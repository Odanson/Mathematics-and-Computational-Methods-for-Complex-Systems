...
# ╔═╡ acd9dee9-236b-4546-9190-cc56fe4222b7
md"""
Actually, $\LaTeX$ is probably easier than word once you've got used to it, even for simple documents like letters. Everybody i know who has mastered LaTeX uses it to write simple letters too! (which then look very professional for zero effort)
"""
...
# ╔═╡ 37f48a95-6aec-49cc-b1c0-6fe2580ad4d8
md"""
![](https://dr282zn36sxxg.cloudfront.net/datastreams/f-d%3A3ba91c5b71742e402ec101e44123306e4540282a144d59ceb4a528b8%2BIMAGE_THUMB_POSTCARD%2BIMAGE_THUMB_POSTCARD.1)
"""
...
function prob_student_is_in_X(mark)
	return missing
end
...
2. **Use the answer to 1.** to determine the expected value and variance of a binomial random variable as a function of $n$ and $p$. You only need to think about how to calculate the variance of a sum of Bernoulli random variables. 
3. (Hard, optional)
...
4. Plot a histogram of ```trial_average(400,100)```. What do you notice about the distribution? Can you explain in terms of the central limit theorem?
...
# ╔═╡ a984bb3d-fff5-4a2b-ba4f-e3b868d56609
random_output() = rand([1,2,4,9])

# ╔═╡ a5229c70-87d3-4761-8e52-7cce04d1ada5
histogram([???? for i in 1:1000], bar_width=1) # fill this code for 1.
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "55d60c89149ff86d88eeb38b4a7ca7e000a416a8"
